...
public class TransactionEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public net.consensys.eventeum.TransactionDetails details;
   ...
   */
  public TransactionEvent(String id, String type, net.consensys.eventeum.TransactionDetails details, Integer retries) {
    this.id = id;
    this.type = type;
  ...
  public void put(int field$, Object value$) {
    ...
    case 2: details = (net.consensys.eventeum.TransactionDetails)value$; break;
   ...
   */
  public net.consensys.eventeum.TransactionDetails getDetails() {
    return details;
  }
   ...
   * @param value the value to set.
   */
  public void setDetails(net.consensys.eventeum.TransactionDetails value) {
    this.details = value;
  }
   ...
   */
  public static net.consensys.eventeum.TransactionEvent.Builder newBuilder() {
    return new net.consensys.eventeum.TransactionEvent.Builder();
  }
   ...
   * @return A new TransactionEvent RecordBuilder
   */
  public static net.consensys.eventeum.TransactionEvent.Builder newBuilder(net.consensys.eventeum.TransactionEvent.Builder other) {
    if (other == null) {
      return new net.consensys.eventeum.TransactionEvent.Builder();
    } else {
      return new net.consensys.eventeum.TransactionEvent.Builder(other);
    }
  }
   ...
   * @return A new TransactionEvent RecordBuilder
   */
  public static net.consensys.eventeum.TransactionEvent.Builder newBuilder(net.consensys.eventeum.TransactionEvent other) {
    if (other == null) {
      return new net.consensys.eventeum.TransactionEvent.Builder();
    } else {
      return new net.consensys.eventeum.TransactionEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TransactionEvent>
    ...
    private String id;
    private String type;
    private net.consensys.eventeum.TransactionDetails details;
    private net.consensys.eventeum.TransactionDetails.Builder detailsBuilder;
    private int retries;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(net.consensys.eventeum.TransactionEvent.Builder other) {
      super(other);
      ...
      if (other.hasDetailsBuilder()) {
        this.detailsBuilder = net.consensys.eventeum.TransactionDetails.newBuilder(other.getDetailsBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(net.consensys.eventeum.TransactionEvent other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public net.consensys.eventeum.TransactionEvent.Builder setId(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.consensys.eventeum.TransactionEvent.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.consensys.eventeum.TransactionEvent.Builder setType(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.consensys.eventeum.TransactionEvent.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.consensys.eventeum.TransactionEvent.Builder setDetails(net.consensys.eventeum.TransactionDetails value) {
     ...
     * @return This builder.
     */
    public net.consensys.eventeum.TransactionDetails.Builder getDetailsBuilder() {
      if (detailsBuilder == null) {
        if (hasDetails()) {
          setDetailsBuilder(net.consensys.eventeum.TransactionDetails.newBuilder(details));
        } else {
          setDetailsBuilder(net.consensys.eventeum.TransactionDetails.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public net.consensys.eventeum.TransactionEvent.Builder setDetailsBuilder(net.consensys.eventeum.TransactionDetails.Builder value) {
      clearDetails();
    ...
    /**
      ...
      * @return This builder.
      */
    public net.consensys.eventeum.TransactionEvent.Builder clearDetails() {
      details = null;
      detailsBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.consensys.eventeum.TransactionEvent.Builder setRetries(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.consensys.eventeum.TransactionEvent.Builder clearRetries() {
    ...
    public TransactionEvent build() {
      try {
        ...
        if (detailsBuilder != null) {
          ...
          record.details = fieldSetFlags()[2] ? this.details : (net.consensys.eventeum.TransactionDetails) defaultValue(fields()[2]);
        }
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (this.details == null) {
        this.details = new net.consensys.eventeum.TransactionDetails();
      }
