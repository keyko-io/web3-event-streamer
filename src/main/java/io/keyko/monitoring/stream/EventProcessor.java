...
public class EventProcessor {
   ...
   * @return KStream<String, ContractEvent> with the events that have been confirmed.
   */
   ...
   * @return KStream<String, EventBlock> with the result of join the event with the block corresponding.
   */
   ...
   *
   * @param topicsToAggregate   List of topics to do the aggregation.
   * @param builder             Stream builder.
   * @param eventBlockAvroSerde EventBlock avro serde.
   * @return KStream<String, AccountCreatedAggregation> with the accounts created aggregation.
   */
   ...
   *
   * @param accountsCreatedDayTable KTable withe the accounts created by day.
   * @param zone                    ZoneId to determine the time zone.
   * @return KStream<String, AccountCreatedAggregation> with the accounts created aggregation.
   */
  ...
  /**
   * Filter the EpochRewardsDistributedToVoters event to release an alert when the
   *
   * @param builder                         Stream builder.
   * @param EpochRewardsDistributedToVoters List with the name of the topic for the aggregation.
   * @param eventBlockAvroSerde             EventBlock avro serde.
   * @return KStream<String, AlertEvent> with the alert event released when the condition is satisfied.
   */
