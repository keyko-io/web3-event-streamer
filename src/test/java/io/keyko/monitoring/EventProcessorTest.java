...
public class EventProcessorTest {
  ...
  public BlockDetailsRecord blockOracleReportedDetails = new BlockDetailsRecord("14750", "0x73090d8e7bb7b2a2b550474c2c90e8059d9bfdcd752c5fc55af18f54debfb88d", "1234", "default");


  public BlockDetailsRecord blockTransferDetails = new BlockDetailsRecord("15129", "0x8ce40858181dccf410331c4b3edf0187ac7b887aeb5c6e0bce2dbc09635f470a", "1234", "default");
  ...
  final Serde<EventRecord> eventAvroSerde = new SpecificAvroSerde<>();
  final Serde<ViewRecord> viewAvroSerde = new SpecificAvroSerde<>();
  final Serde<BlockRecord> blockAvroSerde = new SpecificAvroSerde<>();
  final Serde<EventBlockRecord> eventBlockAvroSerde = new SpecificAvroSerde<>();
  final Serde<ViewBlockRecord> viewBlockAvroSerde = new SpecificAvroSerde<>();
  ...
  public void splitConfirmedTopics() {
    ...
    TestOutputTopic<String, EventBlockRecord> transferTopic = driver.createOutputTopic("transfer", new StringDeserializer(), eventBlockAvroSerde.deserializer());
    TestOutputTopic<String, EventBlockRecord> oracleReportedTopic = driver.createOutputTopic("oraclereported", new StringDeserializer(), eventBlockAvroSerde.deserializer());
